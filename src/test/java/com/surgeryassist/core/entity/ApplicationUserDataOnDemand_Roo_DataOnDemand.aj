...
import com.surgeryassist.core.entity.ApplicationUserDataOnDemand;
...
privileged aspect ApplicationUserDataOnDemand_Roo_DataOnDemand {
    ...
    public void ApplicationUserDataOnDemand.setCreatedDate(ApplicationUser obj, int index) {
        Date createdDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setCreatedDate(createdDate);
    }
    
    public void ApplicationUserDataOnDemand.setModifiedBy(ApplicationUser obj, int index) {
        Integer modifiedBy = new Integer(index);
        obj.setModifiedBy(modifiedBy);
    }
    
    public void ApplicationUserDataOnDemand.setModifiedDate(ApplicationUser obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void ApplicationUserDataOnDemand.setUserEmail(ApplicationUser obj, int index) {
        String userEmail = "foo" + index + "@bar.com";
        obj.setUserEmail(userEmail);
    }
    
    public void ApplicationUserDataOnDemand.setUserInfoID(ApplicationUser obj, int index) {
        UserInfo userInfoID = null;
        obj.setUserInfoID(userInfoID);
    }
    
    public void ApplicationUserDataOnDemand.setUserTypeCode(ApplicationUser obj, int index) {
        UserTypeCode userTypeCode = UserTypeCode.class.getEnumConstants()[0];
        obj.setUserTypeCode(userTypeCode);
    }
    
    public void ApplicationUserDataOnDemand.setVerificationStatus(ApplicationUser obj, int index) {
