...
import com.surgeryassist.core.entity.ApplicationUserIntegrationTest;
...
privileged aspect ApplicationUserIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    private ApplicationUserDataOnDemand ApplicationUserIntegrationTest.dod;
    
    @Test
    public void ApplicationUserIntegrationTest.testCountApplicationUsers() {
    ...
    @Test
    public void ApplicationUserIntegrationTest.testMergeUpdate() {
        ApplicationUser obj = dod.getRandomApplicationUser();
        Assert.assertNotNull("Data on demand for 'ApplicationUser' failed to initialize correctly", obj);
        Integer id = obj.getUserID();
        Assert.assertNotNull("Data on demand for 'ApplicationUser' failed to provide an identifier", id);
    ...
    @Test
    public void ApplicationUserIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'ApplicationUser' failed to initialize correctly", dod.getRandomApplicationUser());
    ...
    @Test
    public void ApplicationUserIntegrationTest.testRemove() {
        ApplicationUser obj = dod.getRandomApplicationUser();
        Assert.assertNotNull("Data on demand for 'ApplicationUser' failed to initialize correctly", obj);
        Integer id = obj.getUserID();
        Assert.assertNotNull("Data on demand for 'ApplicationUser' failed to provide an identifier", id);
